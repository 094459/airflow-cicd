...
class AirflowProvisioningStack(NestedStack):
    def __init__(
        self,
        scope: Construct,
        construct_id: str,
        ...
        **kwargs,
        ...
        # need this for it to work on cdk v2
        ...
        if vpc_id:
            cdk_command += f" -c vpcId={vpc_id} -c envName={env_name}"
        if cidr:
            cdk_command += f" -c cidr={cidr} -c envName={env_name}"
